        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item>
              ...
              <span class="align-middle ml-50" @click.prevent="modalShow = true; userId = data.item.id">Eliminar</span>
            </b-dropdown-item>
          </b-dropdown>
        </template>
...
import usuariosStoreModule from '../usuariosStoreModule'
import UsuarioAnadirNuevo from './UsuarioAnadirNuevo.vue'
...
export default {
  ...
  setup() {
    ...
    // Register module
    if (!store.hasModule(USER_APP_STORE_MODULE_NAME)) store.registerModule(USER_APP_STORE_MODULE_NAME, usuariosStoreModule)
